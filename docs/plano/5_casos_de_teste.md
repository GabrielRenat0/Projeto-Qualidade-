...
| TC-013 | Acessar uma rota inexistente | API acessível | `nonexistent_route`: `/nonexistent-resource` | `GET /nonexistent-resource` | 404; corpo em JSON com um objeto vazio `{}` |
