...
- **Limites do teste de estresse.** O serviço é público e gratuito, então a carga do k6 é mantida modesta. Os resultados mostram o comportamento nesse limite, não a capacidade real do sistema. A rampa até 30 usuários virtuais não degradou o tempo de resposta (p(95) de 29,2 ms, contra 35,6 ms no teste de carga), então o que se mediu é um piso de capacidade, e não o ponto de saturação do serviço.
